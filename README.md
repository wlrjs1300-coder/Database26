...
mysql 설치를 진행한다.
https://dev.mysql.com/downloads/mysql (LTS 버전을 선택)

mysql 설치 중 오류가 발생하면 vs code 라이브러리 설치
구글 검색 : Visual C++ Redistributable v14 (vc_redist.x64.exe) 필요

mysql 관련 프로그램을 설치한다.
https://dev.mysql.com/downloads/workbench/
```
데이터베이스 : 자료를 24시간 365일동안 보관하며 서비스 제공
...
: 데이터베이스, 테이블, 사용자, 뷰, 인덱스, 스키마 등 생성/수정 및 삭제
...
R(찾아오기) : SELECT 필드명 FROM 테이블 WHERE 조건
...
COMMIT  : 트렌젝션 저장
GRANT  : 권한 부여 (관리자가 사용자에게 테이블 및 기능의 권한 부여)
REVOKE   : 권한 삭제
```
